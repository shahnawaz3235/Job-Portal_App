...
import InputField from '../components/InputField'; // A reusable InputField component
import Button from '../components/Button'; // A reusable styled Button component
        ...
        <div className="bg-yellow-50 p-6 rounded-lg shadow-md">
          ...
          <div className="job-info mb-4">
            ...
            {singleJob.personalWebsites && (
              <Link to={singleJob.personalWebsites.url}>
